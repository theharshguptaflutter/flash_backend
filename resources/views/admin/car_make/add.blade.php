...
<div class="content-wrapper">
    ...
    <section class="content">
       <div class="row">
            <div class="col-xs-12">
                <div class="box"><!-- /.box -->
                <form id="doc_status" method="post" action="{{ route('car-make-store') }}">
                    @csrf
                    <div class="box-body">         
                        ...
                        <div class="card-footer clearfix">
                            <button type="button" onclick="validateCarMake()" name="Add" id="add" class="btn btn-info update_btn">Add</button>                                    
                        </div> 
                    </div><!-- /.box-body -->
                </form>
                </div><!-- /.box -->
